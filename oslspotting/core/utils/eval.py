...
from oslspotting.core.utils.io import load_json, store_gz_json, store_json
...
def evaluate_e2e(model, dali, dataset, split, classes, save_pred, calc_stats=True,
             save_scores=True, dataloader_params = None, return_pred = False):
    # print(dataset.)
    pred_dict = {}
    ...
    if return_pred : return pred_events_high_recall
    return avg_mAP
