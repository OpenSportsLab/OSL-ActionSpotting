...
#     train=dict(
#         type='CocoDataset',
#         ann_file='/opt/ml/input/data/training/Training.json',
#         img_prefix='',
#         pipeline=[
#             dict(type='LoadImageFromFile'),
#             dict(type='LoadAnnotations', with_bbox=True),
...
#             dict(type='Collect', keys=['img', 'gt_bboxes', 'gt_labels'])
#         ],
#         classes=('radicle', 'seed')),
#     val=dict(
#         type='CocoDataset',
#         ann_file='/opt/ml/input/data/training/Validation.json',
#         img_prefix='',
#         pipeline=[
#             dict(type='LoadImageFromFile'),
#             dict(
...
#     test=dict(
#         type='CocoDataset',
#         ann_file='/opt/ml/input/data/training/Testing.json',
#         img_prefix='',
#         pipeline=[
#             dict(type='LoadImageFromFile'),
#             dict(
...
# workflow = [('train', 1)]
# classes = ('radicle', 'seed')
# work_dir = '/opt/ml/model/training'
# gpu_ids = range(0, 1)