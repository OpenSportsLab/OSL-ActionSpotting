...
from oslactionspotting.core.runner import timestamp_half

from oslactionspotting.models.litebase import LiteBaseModel
from oslactionspotting.models.utils import create_folders, get_json_data, get_prediction_data, get_spot_from_NMS, zipResults
...
class LiteLearnablePoolingModel(LiteBaseModel):
    def __init__(self, cfg=None, weights=None, confidence_treshold = 0.0,
                backbone="PreExtracted", 
                neck="NetVLAD++", 
                head="LinearLayer", 
                post_proc="NMS",
        ...
        self.confidence_threshold = confidence_treshold
        ...
        if not self.stop_predict:
            if self.runner == "runner_pooling":
                ...
                if self.infer_split :
                    ...
                    output_file = os.path.join(self.cfg.work_dir, self.output_folder, game_ID, "results_spotting.json")
                else : 
